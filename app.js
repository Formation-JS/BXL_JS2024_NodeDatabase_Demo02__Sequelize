...
async function getPaginationPlat() {
...
const recetteId = await ajouterRecette();


async function getInfoRecette(id) {
...
await getInfoRecette(recetteId);
